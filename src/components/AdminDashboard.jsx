  ...
  const AdminDashboard = () => {
    ...
    const fetchOffices = async () => {
      try {
        const response = await axios.get(`${process.env.REACT_APP_API_URL}/api/offices`);
    ...
    const fetchSurveys = async () => {
      try {
        const response = await axios.get(`${process.env.REACT_APP_API_URL}/api/surveys`);
    ...
    const fetchTotalRespondents = async (officeId, surveyId) => {
      try {
        const endpoint = officeId ? `${process.env.REACT_APP_API_URL}/api/responses/${officeId}/${surveyId}` : `${process.env.REACT_APP_API_URL}/api/responses/all/${surveyId}`;
    ...
    const fetchAnswerData = async (officeId, surveyId) => {
      try {
        const endpoint = officeId ? `${process.env.REACT_APP_API_URL}/api/answers/${officeId}/${surveyId}` : `${process.env.REACT_APP_API_URL}/api/answers/all/${surveyId}`;
        const response = await axios.get(endpoint);
