...
const OfficeSurvey = () => {
    ...
    useEffect(() => {
        const fetchSurvey = async () => {
            try {
                const response = await axios.get(`${process.env.REACT_APP_API_URL}/api/surveys/${surveyId}`);
    ...
    useEffect(() => {
        const fetchOffice = async () => {
            try {
                const response = await axios.get(`${process.env.REACT_APP_API_URL}/api/offices/${officeId}`);
    ...
    const fetchServices = async () => {
        try {
            const response = await fetch(`${process.env.REACT_APP_API_URL}/api/offices/${officeId}/services`);
    ...
    const fetchPersonnel = async () => {
        try {
            const response = await fetch(`${process.env.REACT_APP_API_URL}/api/offices/${officeId}/personnel`);
            const data = await response.json();
    ...
    useEffect(() => {
        // Fetch roles
        axios.get(`${process.env.REACT_APP_API_URL}/api/infos/roles`)
            .then(response => setRoles(response.data))
            .catch(error => console.error("Error fetching roles:", error));

        // Fetch colleges
        axios.get(`${process.env.REACT_APP_API_URL}/api/infos/colleges`)
            .then(response => setColleges(response.data))
            .catch(error => console.error("Error fetching colleges:", error));

        // Fetch regions
        axios.get(`${process.env.REACT_APP_API_URL}/api/infos/regions`)
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await axios.post(`${process.env.REACT_APP_API_URL}/api/responses/submit`, {
                survey_id: selectedSurveyId,
                office_id: selectedOfficeId,
                type: clientType,
                role: roleType,
